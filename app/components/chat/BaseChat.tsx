                ...
                >
                  <svg className={classNames(styles.PromptEffectContainer)}>
                    <defs>
                      ...
                      >
                        <stop offset="0%" stopColor="#14B8A6" stopOpacity="0%"></stop>
                        <stop offset="40%" stopColor="#14B8A6" stopOpacity="80%"></stop>
                        <stop offset="50%" stopColor="#14B8A6" stopOpacity="80%"></stop>
